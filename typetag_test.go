...
func TestParseTypeTag(t *testing.T) {
	...
	tests := []struct {
		...
		{"invalid bool generic", "bool<T0>", nil, true},
		{"invalid address generic", "address<T0>", nil, true},
		{"invalid signer generic", "signer<T0>", nil, true},
		{"invalid u8 generic", "u8<T0>", nil, true},
		{"invalid u16 generic", "u16<T0>", nil, true},
		{"invalid u32 generic", "u32<T0>", nil, true},
