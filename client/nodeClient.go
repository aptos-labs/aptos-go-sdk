...
func (rc *NodeClient) Account(address types.AccountAddress, ledgerVersion ...uint64) (info types.AccountInfo, err error) {
...
func (rc *NodeClient) AccountResource(address types.AccountAddress, resourceType string, ledgerVersion ...uint64) (data map[string]any, err error) {
...
func (rc *NodeClient) AccountResources(address types.AccountAddress, ledgerVersion ...uint64) (resources []types.AccountResourceInfo, err error) {
...
// Optionally, a ledgerVersion can be given to get the account state at a specific ledger version
func (rc *NodeClient) AccountResourcesBCS(address types.AccountAddress, ledgerVersion ...uint64) (resources []types.AccountResourceRecord, err error) {
	au := rc.baseUrl.JoinPath("accounts", address.String(), "resources")
	if len(ledgerVersion) > 0 {
		params := url.Values{}
		params.Set("ledger_version", strconv.FormatUint(ledgerVersion[0], 10))
...
func (rc *NodeClient) SubmitTransaction(signedTxn *types.SignedTransaction) (data *api.SubmitTransactionResponse, err error) {
...
func (rc *NodeClient) BatchSubmitTransaction(signedTxns []*types.SignedTransaction) (response *api.BatchSubmitTransactionResponse, err error) {
...
//
// TODO: This needs to support types.RawTransactionWithData
// TODO: Support multikey simulation
func (rc *NodeClient) SimulateTransaction(rawTxn *types.RawTransaction, sender types.TransactionSigner, options ...any) (data []*api.UserTransaction, err error) {
...
type FeePayer *types.AccountAddress

// AdditionalSigners will set the additional signers for a transaction
type AdditionalSigners []types.AccountAddress
...
//   - [FeePayer]
//   - [AdditionalSigners]
func (rc *NodeClient) BuildTransaction(sender types.AccountAddress, payload types.TransactionPayload, options ...any) (rawTxn *types.RawTransaction, err error) {
...
//   - [FeePayer]
//   - [AdditionalSigners]
func (rc *NodeClient) BuildTransactionMultiAgent(sender types.AccountAddress, payload types.TransactionPayload, options ...any) (rawTxnImpl *types.RawTransactionWithData, err error) {
	...
	var feePayer *types.AccountAddress
	var additionalSigners []types.AccountAddress
	...
	if feePayer != nil {
		return &types.RawTransactionWithData{
			Variant: types.MultiAgentWithFeePayerRawTransactionWithDataVariant,
			Inner: &types.MultiAgentWithFeePayerRawTransactionWithData{
				RawTxn:           rawTxn,
				FeePayer:         feePayer,
		...
		return &types.RawTransactionWithData{
			Variant: types.MultiAgentRawTransactionWithDataVariant,
			Inner: &types.MultiAgentRawTransactionWithData{
				RawTxn:           rawTxn,
				SecondarySigners: additionalSigners,
			},
		}, nil
...
func (rc *NodeClient) buildTransactionInner(
	...
	chainId uint8,
	haveChainId bool,
) (rawTxn *types.RawTransaction, err error) {
...
type ViewPayload struct {
	Module   types.ModuleId  // types.ModuleId of the View function e.g. 0x1::coin
	Function string          // Name of the View function e.g. balance
	ArgTypes []types.TypeTag // types.TypeTags of the type arguments
...
func (rc *NodeClient) EstimateGasPrice() (info types.EstimateGasInfo, err error) {
...
func (rc *NodeClient) AccountAPTBalance(account types.AccountAddress) (balance uint64, err error) {
	accountBytes, err := bcs.Serialize(&account)
	if err != nil {
		return 0, err
	}
	values, err := rc.View(&ViewPayload{Module: types.ModuleId{
...
func (rc *NodeClient) BuildSignAndSubmitTransaction(sender types.TransactionSigner, payload types.TransactionPayload, options ...any) (data *api.SubmitTransactionResponse, err error) {
