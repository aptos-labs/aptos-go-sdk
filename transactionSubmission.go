...
func (snt *SequenceNumberTracker) Increment() uint64 {
	return snt.SequenceNumber.Add(1)
}
...
func (rc *NodeClient) BuildTransactions(sender AccountAddress, payloads chan TransactionBuildPayload, responses chan TransactionBuildResponse, setSequenceNumber chan uint64, options ...any) {
	(*ExposedNodeClient)(rc).BuildTransactions(context.Background(), sender, payloads, responses, setSequenceNumber, options...)
}
...
func (client *Client) SubmitTransactions(requests chan TransactionSubmissionRequest, responses chan TransactionSubmissionResponse) {
	client.nodeClient.SubmitTransactions(context.Background(), requests, responses)
}
...
func (rc *NodeClient) SubmitTransactions(requests chan TransactionSubmissionRequest, responses chan TransactionSubmissionResponse) {
	(*ExposedNodeClient)(rc).SubmitTransactions(context.Background(), requests, responses)
}
...
func (rc *NodeClient) BatchSubmitTransactions(requests chan TransactionSubmissionRequest, responses chan TransactionSubmissionResponse) {
	(*ExposedNodeClient)(rc).BatchSubmitTransactions(context.Background(), requests, responses)
}
...
func (client *Client) BuildSignAndSubmitTransactions(
	...
	client.nodeClient.BuildSignAndSubmitTransactions(context.Background(), sender, payloads, responses, buildOptions...)
}
...
func (rc *NodeClient) BuildSignAndSubmitTransactions(
	...
	(*ExposedNodeClient)(rc).BuildSignAndSubmitTransactions(context.Background(), sender, payloads, responses, buildOptions)
}
...
func (rc *NodeClient) BuildSignAndSubmitTransactionsWithSignFunction(
	...
	(*ExposedNodeClient)(rc).BuildSignAndSubmitTransactionsWithSignFunction(context.Background(), sender, payloads, responses, sign, buildOptions)
}

// BuildTransactions start a goroutine to process [TransactionPayload] and spit out [RawTransactionImpl].
func (rc *ExposedNodeClient) BuildTransactions(ctx context.Context, sender AccountAddress, payloads chan TransactionBuildPayload, responses chan TransactionBuildResponse, setSequenceNumber chan uint64, options ...any) {
	// Initialize state
...
// SubmitTransactions consumes signed transactions, submits to aptos-node, yields responses.
// closes output chan `responses` when input chan `signedTxns` is closed.
func (rc *ExposedNodeClient) SubmitTransactions(ctx context.Context, requests chan TransactionSubmissionRequest, responses chan TransactionSubmissionResponse) {
...
// BatchSubmitTransactions consumes signed transactions, submits to aptos-node, yields responses.
// closes output chan `responses` when input chan `signedTxns` is closed.
func (rc *ExposedNodeClient) BatchSubmitTransactions(ctx context.Context, requests chan TransactionSubmissionRequest, responses chan TransactionSubmissionResponse) {
	defer close(responses)
...
// BuildSignAndSubmitTransactions starts up a goroutine to process transactions for a single [TransactionSender]
// Closes output chan `responses` on completion of input chan `payloads`.
func (rc *ExposedNodeClient) BuildSignAndSubmitTransactions(
	ctx context.Context,
	sender TransactionSigner,
	payloads chan TransactionBuildPayload,
	responses chan TransactionSubmissionResponse,
...
//
//	}
func (rc *ExposedNodeClient) BuildSignAndSubmitTransactionsWithSignFunction(
	ctx context.Context,
	sender AccountAddress,
	payloads chan TransactionBuildPayload,
	responses chan TransactionSubmissionResponse,
